...
function ShareModal({ isOpen, onClose }) {
  ...
  const shareText = encodeURIComponent("I just took action with GreedPeaceX! It’s time to fight back against corporate greed. #GreedPeaceX #ActionCampaign");
  ...
  const shareLinks = {
    ...
    Mail: `mailto:?subject=${shareText}&body=${shareUrl}`,
