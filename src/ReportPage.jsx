...
// Component containing the M&S report content
...
// Component containing the Invisible Hand content
...
function ReportPage({ reportComponent }) {
    ...
    switch (reportComponent) {
        ...
        case 'invisiblehand':
            header = {
                ...
                subtitle: "The Seven Companies Controlling Your Food, Energy & Rent",
                byline: "By GreedPeaceX Investigations Team | Published: Coming Soon"
            };
    ...
    // Helper function to open the general signup modal (needs to call the general modal in App)
    const openGeneralSignupModal = () => {
        // Since ReportPage doesn't know about the global modals, we'll redirect to the Support page
        // or show a simple alert for now. Redirecting is cleaner.
