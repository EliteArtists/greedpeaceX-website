...
import Modal from './Modal'; // Necessary for Sign Petition / Join Movement
import ShareModal from './ShareModal'; // Necessary for Share
...
function ReportPage() {
  ...
  // Logic to determine which report to show based on URL slug
  // NOTE: In a final production environment, this would dynamically fetch data.
  // For now, we manually route based on the slug.
  ...
  switch (slug) {
    case 'real-cost-of-green':
      ...
      reportContent = (
        <>
          {/* Article Title Header (Yellow Box) - CENTRALIZED */}
          <div className="bg-yellow-400 text-black p-6 mb-8 text-center">
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
              THE REAL COST OF GREEN
            </h1>
            <h3 className="text-xl md:text-2xl font-bold mt-2">
              How M&S Monetizes Plastic While Hiding the Profits
            </h3>
            <p className="text-sm md:text-base mt-2 border-t border-black pt-2 mx-auto inline-block">
              By Rhea Solace GreedPeaceX Investigations Team | Published: October 2025
            </p>
          </div>
          
          {/* EXECUTIVE SUMMARY (Heading removed) */}
